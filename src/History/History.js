...
class History extends Component {
    ...
    getTodayPrice() {
        ...
        let t = moment().unix()
        // axios.all is used to make concurrent API requests. These requests were the func
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                let f = {
                    date: moment.unix(t).format("DD/MM/YYYY"),
    ...
    // This is called when an instance of a component is being created and inserted into t
    componentWillMount() {
        this.getTodayPrice();
    ...
    render() {
        return (
            <div className="history--section container">
                <h2>Histórico (Últimos 5 dias)</h2>
